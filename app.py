...
SUNLIGHT_EMAIL = os.environ.get("SUNLIGHT_EMAIL", None)
...
def index():
    return render_template("index.html", ga_account=GA_ACCOUNT, ga_domain_name=GA_DOMAIN_NAME, sunlight_email=SUNLIGHT_EMAIL, sunlight_api_key=SUNLIGHT_API_KEY)
